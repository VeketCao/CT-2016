 ...
 (function($){
	...
	$.extend($.PaginationRenderers.defaultRenderer.prototype, {
		...
		getLinks:function(current_page, eventHandler) {
            ...
            fragment.append('<span class="page_f">可跳转至</span><input class="pageNum" type="text" id="setPage" onkeypress="return event.charCode >= 49 && event.charCode <= 57"/><span class="page_f">页</span>');
			return fragment;
		}
	});
